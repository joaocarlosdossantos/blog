...
$(function() {
    ...
    */
    ...
    function itensVenda(json){
        ...
        "<h2 id='saldofinal'>Valor total: <strong>$ "+parseFloat(json.valor_total).toFixed(2)+"</strong></h2>");
        ...
        $('#tabela-itens').html(
                ...
                for(var i=0;itens.length>i;i++){
                            ...
                            '<div class="txt-color-white inline-block">'+
                                '<div class="btn-group">'+
                                    ...
                                    '<ul class="dropdown-menu pull-left text-left" style="background-color:black;">'+
                                        ...
                                        '<li class="divider"></li>'+
                                        '<li>'+
                                            '<a style="cursor:pointer;color:white;" title="'+itens[i].status+'" id="alterar-item-'+itens[i].id+'">ALTERAR ÍTEM</a>'+
                                         '</li>'+
                                         '<li class="divider"></li>'+
                                         '<li>'+
                                            '<a style="cursor:pointer;color:white;" title="'+itens[i].status+'" id="cancelar-item-'+itens[i].id+'">CANCELAR ÍTEM</a>'+
                                         '</li>'+
                                         '<li class="divider"></li>'+
                                    '</ul>'+
                                '</div>'+
                    ...
                    '<td class="'+itens[i].classe+'">'+itens[i].data_saida+'</td>'+
                        ...
                        '</div>'+
                    '</td>'+
                    '<td class="'+itens[i].classe+'">'+itens[i].vendedor+'</td>'+
