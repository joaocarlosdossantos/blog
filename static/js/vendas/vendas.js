                                ...
                                '<div class="btn-group">'+
                                    ...
                                    '<ul class="dropdown-menu pull-left text-left" style="">'+
                                        ...
                                        '<li>'+
                                         ...
                                         '<li class="divider"></li>'+
                                         '<li>'+
                                            '<a style="cursor:pointer;color:black;" title="'+json[i].status_pedido+'" id="imprimir-pedido-'+json[i].id+'">IMPRIMIR CUPOM 1 VIA</a>'+
                                         '</li>'+
                                         '<li class="divider"></li>'+
                                         '<li>'+
                                            '<a style="cursor:pointer;color:black;" title="'+json[i].status_pedido+'" id="imprimir-pedido2-'+json[i].id+'">IMPRIMIR CUPOM 2 VIAS</a>'+
                                         '</li>'+
                                         '<li class="divider"></li>'+
                                         '<li>'+
