$(function() {
        ...
        $.ajax({
            ...
            success : function(json) {
                ...
                for(var i=0;json.length>i;i++){
                            ...
                            '<div class="txt-color-white inline-block">'+
                                '<div class="btn-group">'+
                                    ...
                                    '<ul class="dropdown-menu pull-left text-left" style="background-color:black;">'+
                                        ...
                                        '<li class="divider"></li>'+
                                        '<li>'+
                                            '<a style="cursor:pointer;color:white;" title="'+json[i].status_pedido+'" id="adicionar-produto-venda-'+json[i].id+'">ADICIONAR PRODUTO</a>'+
                                         '</li>'+
                                         '<li class="divider"></li>'+
                                         '<li>'+
                                            '<a style="cursor:pointer;color:white;" title="'+json[i].status_pedido+'" id="mostar-itens-'+json[i].id+'">MOSTRAR ÍTENS DO PEDIDO</a>'+
                                         '</li>'+
                                         '<li class="divider"></li>'+
                                        '<li>'+
                                            '<a style="cursor:pointer;color:white;" title="'+json[i].status_pedido+'" id="buscar-venda-'+json[i].id+'">ALTERAR PEDIDO</a>'+
                                         '</li>'+
                                         '<li class="divider"></li>'+
                                         '<li>'+
                                            '<a style="cursor:pointer;color:white;" title="'+json[i].status_pedido+'" id="finalizar-venda-'+json[i].id+'">FINALIZAR VENDA</a>'+
                                         '</li>'+
                                         '<li class="divider"></li>'+
                                         '<li>'+
                                            '<a style="cursor:pointer;color:white;" title="'+json[i].status_pedido+'" id="imprimir-pedido-'+json[i].id+'">IMPRIMIR CUPOM 1 VIA</a>'+
                                         '</li>'+
                                         '<li class="divider"></li>'+
                                         '<li>'+
                                            '<a style="cursor:pointer;color:white;" title="'+json[i].status_pedido+'" id="imprimir-pedido2-'+json[i].id+'">IMPRIMIR CUPOM 2 VIAS</a>'+
                                         '</li>'+
                                         '<li class="divider"></li>'+
                                         '<li>'+
                                            '<a style="cursor:pointer;color:white;" title="'+json[i].status_pedido+'" id="concluido1-entregue-'+json[i].id+'">MARCAR COMO ENTREGUE</a>'+
                                         '</li>'+
                                         '<li class="divider"></li>'+
                                         '<li>'+
                                            '<a style="cursor:pointer;color:white;" title="'+json[i].status_pedido+'" id="concluido1-nao-entregue-'+json[i].id+'">MARCAR COMO NÃO ENTREGUE</a>'+
                                         '</li>'+
                                         '<li class="divider"></li>'+
                                         '<li>'+
                                            '<a style="cursor:pointer;color:white;" title="'+json[i].status_pedido+'" id="cancelar-pedido-'+json[i].id+'">CANCELAR PEDIDO</a>'+
                                         '</li>'+
                                         '<li class="divider"></li>'+
                                         '<li>'+
                                            '<a style="cursor:pointer;color:white;" title="'+json[i].status_pedido+'" id="pagamentos-conta-'+json[i].id+'">GERENCIAR PAGAMENTOS</a>'+
                                         '</li>'+
                                         '<li class="divider"></li>'+
                                    '</ul>'+
                                '</div>'+
                            ...
                            '<div class="txt-color-white inline-block">'+
                                '<div class="btn-group">'+
                                    ...
                                    '<ul class="dropdown-menu pull-left text-left" style="background-color:black;">'+
                                        ...
                                        '<li class="divider"></li>'+
                                         '<li>'+
                                            '<a style="cursor:pointer;color:white;" title="'+json[i].status_pedido+'" id="concluido-entregue-'+json[i].id+'">MARCAR COMO ENTREGUE</a>'+
                                         '</li>'+
                                         '<li class="divider"></li>'+
                                         '<li>'+
                                            '<a style="cursor:pointer;color:white;" title="'+json[i].status_pedido+'" id="concluido-nao-entregue-'+json[i].id+'">MARCAR COMO NÃO ENTREGUE</a>'+
                                         '</li>'+
                                         '<li class="divider"></li>'+
                                         '<li>'+
                                            '<a style="cursor:pointer;color:white;" title="'+json[i].status_pedido+'" id="cancelar1-pedido-'+json[i].id+'">CANCELAR PEDIDO</a>'+
                                         '</li>'+
                                         '<li class="divider"></li>'+
                                    '</ul>'+
                                '</div>'+
                    ...
                    '<td class="'+json[i].classe+'">'+json[i].usuario+'</td>'+
    ...
    $("#corpo").on('click', 'a[id^=imprimir-pedido-]', function(){
        ...
        if (status == 'CONCLUIDO NAO ENTREGUE'){
            ...
            success : function(json) {
                if (json.permissoes){
                window.open('/vendas/imprimir-cupom-nao-fiscal/'+id_venda+'/');
                }else if(json.erro){
                mensagemErroOperacao(json)
                }else if(json.info){
    ...
    $("#corpo").on('click', 'a[id^=imprimir-pedido2-]', function(){
        status = $(this).attr('title');
        id_venda = $(this).attr('id').split('-')[2];
        if (status == 'CONCLUIDO NAO ENTREGUE'){
            window.open('/vendas/imprimir-cupom-nao-fiscal/'+id_venda+'/?vias=2');
        }else if(status == 'EM ANDAMENTO' || status == 'CONCLUIDO E ENTREGUE'){
            mensagemInfo('AÇÃO INTERROMPIDA PELO SISTEMA...','Somente é possível imprimir pedidos que já estejam concluídos. Os mesmos não podem ter sido ainda entregues e nem cancelados...');
        }else if(status == 'CANCELADO'){
            mensagemInfo('AÇÃO INTERROMPIDA PELO SISTEMA...','Não há pagamentos referente a esta venda, pois a mesma foi cancelada...');
